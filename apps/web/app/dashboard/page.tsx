...
export default async function DashboardOverviewPage() {
  ...
  const [
    ...
    db
      ...
      .where(
        and(
          eq(draftReplies.workspaceId, workspaceId),
          eq(draftReplies.status, "generated")
        )
      ),
    db
      .select({
      ...
      .where(
        and(
          ...
          eq(meetingProposals.status, "proposed")
        )
      ),
  ...
  const briefingCount = latestBriefing
    ? ((latestBriefing.items as BriefingItem[]) ?? []).length
    : 0;
        ...
        <div className="grid flex-1 gap-3 md:grid-cols-3">
          ...
          <Card className="rounded-[1.5rem] border-info/25 bg-card shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Generated replies waiting on a human decision.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-4xl font-semibold tracking-tight text-foreground">
          ...
          <Card className="rounded-[1.5rem] border-success/25 bg-card shadow-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-foreground">
                Meeting proposals waiting
              </CardTitle>
              <CardDescription>
                Scheduling intents needing review before creation.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-4xl font-semibold tracking-tight text-foreground">
        ...
        <div className="space-y-6">
          <Card className="rounded-[1.6rem] border-border/80 bg-card/90 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Jump straight into the next working area.
              </CardDescription>
            </CardHeader>
