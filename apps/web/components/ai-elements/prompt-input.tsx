  ...
  const inner = (
    <>
      ...
      <form
        ...
        {...props}
      >
        <InputGroup className="overflow-hidden h-full">{children}</InputGroup>
      </form>
    </>
  );
...
type PromptInputSubmitOnClick = NonNullable<PromptInputSubmitProps["onClick"]>;
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback<PromptInputSubmitOnClick>(
    (e) => {
